...
```json
{
  ...
  "delay_time": 1, # время задержки перед заупском нового цикла скрипта
  ...
  "exception_delay": 60 # задержка перед возобновлением работы скрипта при взникновении ошибок в секундах
}
```
...
Для прекращения работы используйсте комбинацию `Ctrl + C`
